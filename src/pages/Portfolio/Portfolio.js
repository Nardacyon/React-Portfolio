        ...
        return (
            <div className="portfolio">
                ...
                <div className="p-b-container">
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://nardacyon.github.io/WeatherDashboard/" target="_blank" rel="noreferrer nofollow">Weather Dashboard </a>
                            <p>This site allows the user to search up a location and find the weather outlook as well as a 5 day forecast.</p>
                            <a className="repo" to="https://github.com/Nardacyon/WeatherDashboard/" target="_blank" rel="noreferrer nofollow">Github Repo Here!</a>
                        </div>
                        <img src={weather} alt="Weather and forecast app"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://nardacyon.github.io/Day-Planner/" target="_blank" rel="noreferrer nofollow">Day Planner</a>
                            ...
                            <a className="repo" to="https://github.com/Nardacyon/Day-Planner/" target="_blank" >Github Repo Here!</a>
                        </div>
                        <img src={day_planner} alt="Day planner app"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://nardacyon.github.io/LocationLookup/" target="_blank" rel="noreferrer nofollow">Location Lookup</a>
                            ...
                            <a className="repo" to="https://github.com/Nardacyon/LocationLookup/" target="_blank" rel="noreferrer nofollow">Github Repo Here!</a>
                        </div>
                ...
                <div className="p-b-container">
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://gitgudburgers.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Git Gud Burger</a>
                            ...
                            <a className="repo" to="https://github.com/Nardacyon/GitGudBurger" target="_blank" rel="noreferrer nofollow">Github Repo Here!</a>
                        </div>
                        <img src={GGBurger} alt="Git Gud Burger Page"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://kt-note-taker.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Note Taker</a>
                            <p>This app was one of my earlier works, its purpose is to help users plan out their work day. By inputting an event in the text area and clicking save, you can plan your day accordingly.</p>
                            <a className="repo" to="https://github.com/Nardacyon/Note-Taker" target="_blank" rel="noreferrer nofollow">Github Repo Here!</a>
                        </div>
                        <img src={Note_Taker} alt="Note Taker App"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <a to="https://morning-plains-94430.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Black Jack</a>
                            <p>This is a blackjack game using a Deck API, Handlebars, Passport authentication and alpine.js</p>
                            <a className="repo" to="https://github.com/melty100/Blackjack" target="_blank" rel="noreferrer nofollow">Github Repo Here!</a>
                        </div>
