        ...
        return (
            <div className="portfolio">
                ...
                <div className="p-b-container">
                    <div className="p-box">
                        <div className="text-overlay">
                            <Link to="https://nardacyon.github.io/WeatherDashboard/" target="_blank" rel="noreferrer nofollow">Weather Dashboard </Link>
                            <p>This site allows the user to search up a location and find the weather outlook as well as a 5 day forecast.</p>
                            <Link className="repo" to="https://github.com/Nardacyon/WeatherDashboard/" target="_blank" rel="noreferrer nofollow">Github Repo Here!</Link>
                        </div>
                    ...
                    <div className="p-box">
                        <div className="text-overlay">
                            <Link to="https://nardacyon.github.io/LocationLookup/" target="_blank" rel="noreferrer nofollow">Location Lookup</Link>
                            ...
                            <Link className="repo" to="https://github.com/Nardacyon/LocationLookup/" target="_blank" rel="noreferrer nofollow">Github Repo Here!</Link>
                        </div>
                ...
                <div className="p-b-container">
                    <div className="p-box">
                        <div className="text-overlay">
                            <Link to="https://gitgudburgers.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Git Gud Burger</Link>
                            ...
                            <Link className="repo" to="https://github.com/Nardacyon/GitGudBurger" target="_blank" rel="noreferrer nofollow">Github Repo Here!</Link>
                        </div>
                        <img src={GGBurger} alt="Git Gud Burger Page"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <Link to="https://kt-note-taker.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Note Taker</Link>
                            <p>This app was one of my earlier works, its purpose is to help users plan out their work day. By inputting an event in the text area and clicking save, you can plan your day accordingly.</p>
                            <Link className="repo" to="https://github.com/Nardacyon/Note-Taker" target="_blank" rel="noreferrer nofollow">Github Repo Here!</Link>
                        </div>
                        <img src={Note_Taker} alt="Note Taker App"/>
                    </div>
                    <div className="p-box">
                        <div className="text-overlay">
                            <Link to="https://morning-plains-94430.herokuapp.com/" target="_blank" rel="noreferrer nofollow">Black Jack</Link>
                            <p>This is a blackjack game using a Deck API, Handlebars, Passport authentication and alpine.js</p>
                            <Link className="repo" to="https://github.com/melty100/Blackjack" target="_blank" rel="noreferrer nofollow">Github Repo Here!</Link>
                        </div>
